package com.example.android.firstapp.javapracticeapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView txtPassword = (TextView) findViewById(R.id.idLoginPassword);
        Button btnLogin = (Button) findViewById(R.id.idLoginBttn);
